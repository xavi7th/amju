<div class="mt-20">
    ...
    <div class="bg-slate-900 border-b border-white/5 py-12">
        <div class="container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">SME <span class="text-amju-primary">Banking</span></h1>
            <nav class="flex text-sm font-bold text-slate-400 uppercase tracking-widest">
                ...
                <a href="{{ route('banking.sme') }}" class="hover:text-amju-primary transition">SME Banking</a>
                @if($type !== 'main')
                    <span class="mx-3">/</span>
                    <span class="text-amju-primary uppercase">{{ str_replace(['-account', '-current', '-'], ' ', $type) }}</span>
                @endif
            </nav>
        </div>
    </div>
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <aside class="w-full lg:w-1/4">
                    <div class="sticky top-32">
                        ...
                        <div class="mt-12 p-8 bg-amju-primary rounded-[2rem] text-white hidden lg:block">
                            <h4 class="font-black text-xl mb-4">Grow with us</h4>
                            <p class="text-white/80 text-sm mb-6">Empower your business with tailored credit facilities and support.</p>
                            <a href="{{ route('account.open') }}" class="inline-flex items-center px-6 py-3 bg-white text-amju-primary font-black rounded-xl hover:bg-slate-50 transition">
                                Open Account
                            </a>
                        </div>
                    </div>
                ...
                <main class="lg:w-3/4">
                    @if($type === 'main')
                        <div class="space-y-16">
                            <div class="max-w-2xl">
                                <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">Fuel your <span class="text-amju-primary">Business Growth</span></h2>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                @foreach([
                                    ...
                                    <a href="{{ route('banking.sme.product', ['type' => $item['slug']]) }}" class="group p-10 bg-slate-50 rounded-[3rem] border border-slate-100 hover:bg-white hover:shadow-2xl hover:border-amju-primary/10 transition-all duration-500">
                                        <div class="w-14 h-14 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-8 group-hover:bg-amju-primary group-hover:text-white transition-colors">
                                        ...
                                        <span class="text-amju-primary font-black flex items-center group-hover:translate-x-2 transition-transform">
                                            Learn More
                    ...
                    @else
                        <div class="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            @switch($type)
                                ...
                                @case('coporate-current-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <p class="text-amju-deep/80 leading-relaxed">Special current account that allows customers to withdraw with our cheque in any branch of our correspondence commercial bank (Fidelity Bank) all over Nigeria.</p>
                                        </div>
                                        
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                                            <div>
                                                <h4 class="text-xl font-black text-slate-900 mb-6 flex items-center">
                                                    <span class="w-8 h-8 bg-amju-primary text-white rounded-lg flex items-center justify-center mr-3 text-sm">1</span>
                                                    Features
                                                </h4>
                                                <ul class="space-y-4">
                                                    @foreach(['Minimum opening balance of N10,000', 'For individuals and companies', 'Loan & Overdraft applications'] as $feature)
                                                        <li class="flex items-start space-x-3 text-slate-600">
                                                            <svg class="w-6 h-6 text-amju-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                                                            <span>{{ $feature }}</span>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            ...
                                            <div>
                                                <h4 class="text-xl font-black text-slate-900 mb-6 flex items-center">
                                                    <span class="w-8 h-8 bg-amju-primary text-white rounded-lg flex items-center justify-center mr-3 text-sm">2</span>
                                                    Benefits
                                                </h4>
                                                <ul class="space-y-4">
                                ...
                                @case('overdraft-current-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <p class="text-amju-deep/80 leading-relaxed">Optimized for high-volume traders and telecom wholesalers. Competitive interest rates and flexible liquidity access.</p>
                                        </div>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                                            <div>
                                                <h4 class="text-xl font-black text-slate-900 mb-6 flex items-center">
                                                ...
                                                <ul class="space-y-4">
                                                    <li class="flex items-start space-x-3 text-slate-600 font-bold italic text-amju-dark">
                                ...
                                @case('divine-current-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <p class="text-amju-deep/80 leading-relaxed">Specialized financial support for churches. We help you fund assets like instruments, building equipment, generators, and vehicles.</p>
                                        </div>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                                            <div>
                                                <h4 class="text-xl font-black text-slate-900 mb-6 flex items-center">
                                ...
                                @case('cooperative-current-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <p class="text-amju-deep/80 leading-relaxed">Unique finance independence for MPCS accounts. Earn interest and dividends while owning share capital.</p>
                                        </div>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                                            <div>
                                                <h4 class="text-xl font-black text-slate-900 mb-6 flex items-center">
                                ...
                                @case('group-leading-current-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <p class="text-amju-deep/80 leading-relaxed">For existing cooperative societies, Town unions, Trade unions, and specific trade clusters like Garri, Fish, Yam, and Pepper sellers.</p>
                                        </div>
                                        <div class="mt-12 p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                @foreach(['*723*306* EazyBanking', 'Free access to Chequebook', 'Verve Debit Cards', 'Email/SMS Transaction Alerts'] as $benefit)
                                                    <div class="flex items-center space-x-4 p-4 bg-white rounded-2xl border border-slate-100 font-bold text-slate-700">
                                                        <svg class="w-6 h-6 text-amju-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                                                        <span>{{ $benefit }}</span>
                                                    </div>
                                                @endforeach
                                            </div>
                            ...
                            <div class="pt-12 border-t border-slate-100 flex flex-col sm:flex-row gap-6">
                                <a href="{{ route('account.open') }}" class="inline-flex items-center justify-center px-10 py-5 bg-amju-primary text-white font-black text-lg rounded-2xl hover:bg-amju-dark transition shadow-2xl shadow-amju-primary/20">
                                    Open SME Account
                                </a>
