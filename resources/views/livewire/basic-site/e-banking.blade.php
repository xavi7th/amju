<div class="mt-20">
    ...
    <div class="relative bg-slate-900 border-b border-white/5 py-24 overflow-hidden">
        ...
        <div class="relative container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">Digital <span class="text-blue-500">Banking</span></h1>
            <nav class="flex text-sm font-bold text-slate-400 uppercase tracking-widest">
                ...
                <a href="{{ route('banking.e') }}" class="{{ $type === 'main' ? 'text-blue-500' : 'hover:text-blue-500 transition' }}">e-Banking</a>
                @if($type !== 'main')
                    <span class="mx-3">/</span>
                    <span class="text-blue-500 uppercase">{{ str_replace(['-', 'services'], ' ', $type) }}</span>
                @endif
            </nav>
        </div>
    </div>
                ...
                <main class="lg:w-3/4">
                    @if($type === 'main')
                        <div class="space-y-16">
                            <div class="max-w-2xl">
                                <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">Bank <span class="text-blue-600">Anywhere, Anytime</span></h2>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                @foreach([
                                    ...
                                    <a href="{{ route('banking.e.product', ['type' => $service['slug']]) }}" class="p-10 bg-slate-50 rounded-[3rem] border border-slate-100 group hover:bg-white hover:shadow-2xl transition-all duration-500">
                                        <div class="text-blue-600 mb-8 group-hover:scale-110 transition-transform">
                            ...
                            @switch($type)
                                @case('ussd-codes')
                                    <div class="space-y-12">
                                        <div>
                                            <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">USSD Banking <span class="text-blue-600 block text-5xl mt-2">*723*306#</span></h2>
                                            <p class="text-slate-500 text-lg">Amju EazyBanking is a fast, secure, and affordable way to bank 24/7 without internet data.</p>
                                        </div>

                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div class="p-8 bg-blue-50 rounded-[3rem] border border-blue-100">
                                                <h4 class="text-blue-900 font-black mb-6 uppercase text-sm tracking-widest">How to Activate</h4>
                                                <ol class="space-y-4">
                                                    @foreach([
                                                        'Dial *723*306*0#',
                                                        ...
                                                        <li class="flex items-center space-x-4 text-blue-800 font-bold">
                                                            <span class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs leading-none">{{ $index + 1 }}</span>
                                                            <span>{{ $step }}</span>
                                                        </li>
                                                    @endforeach
                                                </ol>
                                            ...
                                            <div class="p-8 bg-slate-900 rounded-[3rem] text-white">
                                                <h4 class="text-blue-500 font-black mb-6 uppercase text-sm tracking-widest">Quick Commands</h4>
                                                <ul class="space-y-4 font-mono text-sm">
                                                    <li class="flex justify-between border-b border-white/10 pb-2"><span>Check Balance:</span> <span class="text-blue-400">*723*306*0#</span></li>
                                                    <li class="flex justify-between border-b border-white/10 pb-2"><span>Airtime (Self):</span> <span class="text-blue-400">*723*306*Amt#</span></li>
                                                    <li class="flex justify-between border-b border-white/10 pb-2"><span>Transfer:</span> <span class="text-blue-400">*723*306*Acc*Amt#</span></li>
                                                    <li class="flex justify-between"><span>Airtime (Others):</span> <span class="text-blue-400">*723*306*Phone*Amt#</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @case('mobile-banking')
                                    <div class="space-y-12">
                                        ...
                                        <div class="bg-blue-600 p-12 rounded-[3rem] text-white flex flex-col md:flex-row items-center gap-12">
                                            <div class="md:w-2/3">
                                                <h3 class="text-3xl font-black mb-6">Bank on the Go</h3>
                                                <p class="text-blue-100 text-lg leading-relaxed mb-8">Download our robust app to manage bills, transfers, and statements online real-time.</p>
                                        ...
                                        <div class="mt-12">
                                            <h4 class="text-2xl font-black text-slate-900 mb-8 border-l-4 border-blue-600 pl-6">Registration Steps</h4>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                @foreach([
                                                    ...
                                                    <div class="p-6 bg-slate-50 border border-slate-100 rounded-2xl flex items-start space-x-4">
                                                        <span class="text-blue-600 font-black text-2xl opacity-20">0{{ $index + 1 }}</span>
                                    ...
                                    <div class="space-y-12">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                                            ...
                                            <div class="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                                                ...
                                                <a href="https://ibank.amjuuniquemfbng.com" target="_blank" class="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-black rounded-xl hover:bg-blue-700 transition">
                                                    Go to Portal
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="space-y-6">
                                                @foreach([
                                                    ...
                                                    <li class="flex items-start space-x-4 pb-6 border-b border-slate-200 last:border-0">
                                                        <span class="text-blue-600 font-black text-lg">{{ $index + 1 }}.</span>
                                                        <span class="font-bold text-slate-700 text-lg">{{ $step }}</span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                            <div class="mt-12">
                                                <a href="#" class="inline-flex items-center px-10 py-5 bg-blue-600 text-white font-black text-lg rounded-2xl hover:bg-blue-700 transition shadow-xl shadow-blue-600/20">
