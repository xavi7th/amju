<div class="mt-20">
    ...
    <div class="bg-slate-900 border-b border-white/5 py-12">
        <div class="container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">About <span class="text-blue-500">Amju Unique</span></h1>
            <nav class="flex text-sm font-bold text-slate-400 uppercase tracking-widest">
                ...
                <a href="{{ route('about') }}" class="{{ $type === 'main' ? 'text-blue-500' : 'hover:text-blue-500 transition' }}">About Us</a>
                @if($type !== 'main')
                    <span class="mx-3">/</span>
                    <span class="text-blue-500 uppercase">{{ str_replace(['-', 'page'], ' ', $type) }}</span>
                @endif
                @if($person)
                    <span class="mx-3">/</span>
                    <span class="text-blue-500 uppercase">{{ str_replace(['-', 'page'], ' ', $person) }}</span>
                @endif
            </nav>
        </div>
    </div>
                ...
                <aside class="w-full lg:w-1/4">
                    <div class="sticky top-32">
                        ...
                        <div class="mt-12 p-8 bg-slate-900 rounded-[2rem] text-white hidden lg:block">
                            ...
                            <a href="{{ route('careers') }}" class="inline-flex items-center text-blue-400 font-bold hover:text-blue-300 transition">
                            ...
                            @switch($person)
                                    ...
                                    <div class="flex flex-col md:flex-row gap-12 mb-12">
                                        <div class="md:w-1/3">
                                            <div class="sticky top-40">
                                                <div class="p-1 bg-gradient-to-tr from-blue-600 to-blue-400 rounded-[2rem] shadow-2xl mb-8">
                                                ...
                                                <p class="text-blue-600 font-bold uppercase tracking-widest text-sm mb-6">MD / CEO</p>
                                                <div class="flex space-x-4">
                                                    <a href="#" class="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition"><i class="fab fa-facebook-f"></i></a>
                                                    <a href="#" class="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition"><i class="fab fa-linkedin-in"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-col md:flex-row gap-12 mb-12">
                                        <div class="md:w-1/3">
                                            <div class="sticky top-40">
                                                ...
                                                <p class="text-blue-600 font-bold uppercase tracking-widest text-sm mb-6">Executive Director</p>
                                            </div>
                                        </div>
                                        <div class="md:w-2/3 space-y-8 prose prose-lg prose-blue max-w-none">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-12 mb-12">
                                        <div class="md:w-1/3">
                                            <div class="sticky top-40">
                                                ...
                                                <p class="text-blue-600 font-bold uppercase tracking-widest text-sm mb-6">General Manager</p>
                                            </div>
                                        </div>
                                        <div class="md:w-2/3 space-y-8 prose prose-lg prose-blue max-w-none">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-12 mb-12">
                                        <div class="md:w-1/3">
                                            <div class="sticky top-40">
                                                ...
                                                <p class="text-blue-600 font-bold uppercase tracking-widest text-sm mb-6">Internal Auditor</p>
                                            </div>
                                        </div>
                                        <div class="md:w-2/3 space-y-8 prose prose-lg prose-blue max-w-none">
                                ...
                                @default
                                    <div class="text-center py-24">
                                        ...
                                        <a href="{{ route('about.us', ['type' => 'management-team']) }}" class="inline-block mt-8 font-black text-blue-600 hover:underline">Back to Team</a>
                                    </div>
                            @endswitch
                        </div>
                    @else
                                        ...
                                        <div class="prose prose-lg prose-slate max-w-none">
                                            ...
                                            <div class="my-16 grid grid-cols-1 md:grid-cols-2 gap-8 not-prose">
                                                <div class="p-10 bg-blue-600 rounded-[3rem] text-white">
                                                    <h4 class="text-2xl font-black mb-6 uppercase tracking-widest text-blue-200">Vision</h4>
                                            ...
                                            @foreach($mgtTeam as $member)
                                                <a href="{{ route('about.team', ['person' => $member['slug']]) }}" class="group block p-6 bg-slate-50 rounded-[2.5rem] border border-slate-100 hover:bg-white hover:shadow-2xl transition-all duration-500 text-center">
                                                    <div class="relative w-32 h-32 mx-auto mb-6">
                                                        <div class="absolute inset-0 bg-blue-600 rounded-full scale-0 group-hover:scale-110 transition-transform duration-500 opacity-10"></div>
                                                        <img src="{{ $member['img'] }}" class="w-full h-full object-cover rounded-full border-4 border-white shadow-lg" alt="{{ $member['name'] }}">
                                                    </div>
                                                    <h4 class="text-xl font-black text-slate-900 group-hover:text-blue-600 transition-colors">{{ $member['name'] }}</h4>
                                                    <p class="text-slate-500 font-bold text-sm uppercase tracking-widest mt-1">{{ $member['role'] }}</p>
                                                    <span class="inline-flex mt-6 text-blue-600 font-black text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">View Bio &rarr;</span>
                                                </a>
                                            @endforeach
                                        </div>
                                    </div>
                                                ...
                                                <div class="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                                                    ...
                                                    <div class="space-y-3 text-slate-600">
                                                        <p class="flex items-start">
                                                            <svg class="w-5 h-5 mr-3 text-blue-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                                            {{ $branch['address'] }}
                                                        </p>
