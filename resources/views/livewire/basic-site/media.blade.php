<div class="mt-20">
    ...
    <div class="bg-slate-900 border-b border-white/5 py-12">
        <div class="container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">MediaHub <span class="text-blue-500">& News</span></h1>
            ...
            <div class="flex space-x-8 overflow-x-auto pb-4 md:pb-0 scrollbar-hide">
                @foreach(['news' => 'Press Release', 'videos' => 'Videos', 'gallery' => 'Photo Gallery'] as $key => $label)
                    <a href="{{ route('site.media', ['type' => $key]) }}" 
                       class="py-6 font-black uppercase text-xs tracking-widest border-b-2 transition-all whitespace-nowrap {{ $type === $key ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-400 hover:text-slate-600' }}">
                        {{ $label }}
                    </a>
                @endforeach
            </div>
            ...
            @switch($type)
                @case('news')
                    <div class="space-y-24">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div class="space-y-8">
                                <h2 class="text-4xl font-black text-slate-900 font-display">Press <span class="text-blue-600">Release</span></h2>
                                <div class="space-y-6">
                                    @php
                                        $pressReleases = [
                                    ...
                                    @foreach($pressReleases as $release)
                                        <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-start space-x-4 group hover:bg-white hover:shadow-xl transition-all">
                                            <div class="w-2 h-2 bg-blue-600 rounded-full mt-2.5 flex-shrink-0 group-hover:scale-150 transition-transform"></div>
                            ...
                            <div class="relative">
                                <div class="p-1 bg-gradient-to-tr from-blue-600 to-blue-400 rounded-[3rem] shadow-2xl overflow-hidden aspect-video md:aspect-square">
                        ...
                        <div class="space-y-16">
                            <div class="max-w-4xl mx-auto text-center">
                                <h3 class="text-3xl font-black text-slate-900 mb-6">What are the benefits of <span class="text-blue-600">Microfinance?</span></h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div class="p-12 bg-slate-900 rounded-[3rem] text-white">
                                <h4 class="text-blue-500 font-black mb-6 uppercase tracking-widest">Regulatory Report</h4>
                            ...
                            <div class="p-12 bg-blue-600 rounded-[3rem] text-white">
                                ...
                                <ul class="space-y-6">
                                    @foreach([
                                        ...
                                        <li class="flex items-center space-x-4 border-b border-white/10 pb-4 last:border-0 last:pb-0">
                                            <div class="w-10 h-10 bg-white text-blue-600 rounded-full flex items-center justify-center flex-shrink-0 font-black">
                ...
                @case('videos')
                    <div class="space-y-16 animate-in fade-in zoom-in duration-500">
                        <div class="max-w-4xl mx-auto text-center">
                            <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">Experience <span class="text-blue-600">Amju Unique</span></h2>
                ...
                @case('gallery')
                    <div class="space-y-16 animate-in fade-in duration-500" x-data="{ open: false, activeSrc: '' }">
                        <div class="max-w-4xl mx-auto text-center">
                            <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">Our <span class="text-blue-600">Moments</span></h2>
                        </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            @foreach($images as $img)
                                <button @click="open = true; activeSrc = '{{ $img }}'" class="group relative aspect-square overflow-hidden rounded-[2rem] border-4 border-slate-50 hover:border-blue-500 transition-all duration-300 shadow-lg">
                                    ...
                                    <div class="absolute bottom-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
                                        <svg class="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" /></svg>
                                    </div>
                                </button>
                            @endforeach
                        </div>
                        ...
                        <div x-show="open" 
                             ...
                             style="display: none;">
                            <button @click="open = false" class="absolute top-8 right-8 text-white hover:text-blue-500 transition">
