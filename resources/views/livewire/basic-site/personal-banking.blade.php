<div class="mt-20">
    ...
    <div class="bg-slate-900 border-b border-white/5 py-12">
        <div class="container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">Personal <span class="text-amju-primary">Banking</span></h1>
            <nav class="flex text-sm font-bold text-slate-400 uppercase tracking-widest">
                ...
                <a href="{{ route('banking.personal') }}" class="{{ $type === 'main' ? 'text-amju-primary' : 'hover:text-amju-primary transition' }}">Personal Banking</a>
                @if($type !== 'main')
                    <span class="mx-3">/</span>
                    <span class="text-amju-primary uppercase">{{ str_replace(['amju-', '-account', '-savings', '-'], ' ', $type) }}</span>
                @endif
            </nav>
        </div>
    </div>
                ...
                <aside class="w-full lg:w-1/4">
                    <div class="sticky top-32">
                        ...
                        <div class="mt-12 p-8 bg-slate-900 rounded-[2rem] text-white hidden lg:block">
                            ...
                            <a href="{{ route('contact') }}" class="inline-flex items-center text-amju-primary font-bold hover:text-amju-dark transition">
                ...
                <main class="lg:w-3/4">
                    @if($type === 'main')
                        ...
                        <div class="space-y-24">
                            <div class="max-w-2xl">
                                <h2 class="text-4xl font-black text-slate-900 mb-6 font-display">Accounts for <span class="text-amju-primary">Everyone</span></h2>
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 bg-slate-900/60"></div>
                                        ...
                                        <div class="p-10">
                                            ...
                                            <a href="{{ route('banking.personal.product', ['type' => $item['slug']]) }}" class="inline-flex items-center px-8 py-4 bg-amju-primary text-white font-black rounded-2xl hover:bg-amju-dark transition shadow-xl shadow-amju-primary/20">
                                                Read More
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            @switch($type)
                                @case('amju-flexy-savings-account')
                                    ...
                                    <div class="prose prose-blue max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <h4 class="text-amju-deep font-black mb-2">Overview</h4>
                                            <p class="text-amju-deep/80">Tailored for individuals seeking a flexible way to save while enjoying modern banking benefits. Ideal for students and young achievers.</p>
                                        </div>
                                ...
                                @case('amju-edusave-savings-account')
                                     ...
                                     <div class="prose prose-amju-primary max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <h4 class="text-amju-deep font-black mb-2">Overview</h4>
                                            <p class="text-amju-deep/80">Secure your child’s future with flexible quality academics through AMJU Unique MFB EDUSAVE. Available to all categories of students.</p>
                                        </div>
                                ...
                                @case('amju-thrift-savings-account')
                                     ...
                                     <div class="prose prose-amju-primary max-w-none">
                                        <div class="bg-amju-primary/10 p-8 rounded-[2rem] border border-amju-primary/10 mb-12">
                                            <h4 class="text-amju-deep font-black mb-2">Overview</h4>
                                            <p class="text-amju-deep/80">Available to individual clubs, associations, cooperatives, and group members. Designed for collective financial growth.</p>
                                        </div>
    ...
    <section class="py-24 bg-slate-900 overflow-hidden relative">
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2">
                    <h2 class="text-4xl md:text-5xl font-black text-white mb-8">Join the <span class="text-amju-primary">Amju Unique</span> Family Today.</h2>
                ...
                <div class="lg:w-1/2 relative">
                    <div class="p-1 w-full bg-gradient-to-tr from-amju-dark to-amju-primary rounded-[3rem]">
