    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            <div class="flex items-center justify-between relative">
                ...
                <div class="absolute top-1/2 left-0 h-0.5 bg-amju-primary -translate-y-1/2 z-0 transition-all duration-500" style="width: {{ ($currentStep - 1) * 50 }}%"></div>
                
                @for ($i = 1; $i <= $totalSteps; $i++)
                    <div class="relative z-10 flex flex-col items-center">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-300 {{ $currentStep >= $i ? 'bg-amju-primary border-amju-primary text-white' : 'bg-white border-slate-200 text-slate-400' }}">
                            @if ($currentStep > $i)
                        ...
                        <span class="mt-2 text-xs font-bold uppercase tracking-wider {{ $currentStep >= $i ? 'text-amju-primary' : 'text-slate-400' }}">
                    ...
                    <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" wire:model="full_name" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none" placeholder="Enter your full name">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="email" wire:model="email" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none" placeholder="email@example.com">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="tel" wire:model="phone" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none" placeholder="+234">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <select wire:model="gender" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none appearance-none">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="date" wire:model="dob" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none">
                        ...
                        <div class="pt-4">
                            <button wire:click="nextStep" class="w-full py-4 bg-amju-primary hover:bg-amju-dark text-white font-bold rounded-2xl transition-all shadow-lg shadow-amju-primary/30">
                    ...
                    <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                ...
                                <select wire:model="acc_type" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none appearance-none">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" wire:model="bvn" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none" placeholder="11-digit BVN">
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea wire:model="address" rows="3" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:border-amju-primary focus:ring-4 focus:ring-amju-primary/10 transition-all outline-none" placeholder="Enter your full address"></textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4">
                            ...
                            <button wire:click="nextStep" class="py-4 bg-amju-primary hover:bg-amju-dark text-white font-bold rounded-2xl transition-all shadow-lg shadow-amju-primary/30">
                                Next Step
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div class="space-y-6">
                            <div class="relative group">
                                ...
                                <label for="passport" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-slate-200 rounded-[2.5rem] bg-slate-50 hover:bg-amju-primary/5 hover:border-amju-primary/50 transition-all cursor-pointer overflow-hidden p-4 text-center">
                                    @if ($user_passport)
                                    ...
                                    @else
                                        <div class="p-6 bg-white rounded-full shadow-sm mb-4">
                                            <svg class="w-8 h-8 text-amju-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div wire:loading wire:target="user_passport" class="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center rounded-[2.5rem]">
                                    <div class="flex items-center space-x-2 text-amju-primary">
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-4">
                            ...
                            <button wire:click="submit" class="py-4 bg-amju-primary hover:bg-amju-dark text-white font-bold rounded-2xl transition-all shadow-lg shadow-amju-primary/30">
                                Submit Application
                            </button>
                        </div>
                    </div>
