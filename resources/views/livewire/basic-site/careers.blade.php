<div class="mt-20">
    ...
    <div class="bg-slate-900 border-b border-white/5 py-12">
        <div class="container mx-auto px-6">
            <h1 class="text-4xl md:text-5xl font-black text-white mb-4">Join Our <span class="text-blue-500">Team</span></h1>
            <nav class="flex text-sm font-bold text-slate-400 uppercase tracking-widest">
                ...
                <a href="{{ route('careers') }}" class="{{ $type === 'main' ? 'text-blue-500' : 'hover:text-blue-500 transition' }}">Careers</a>
                @if($type !== 'main')
                    <span class="mx-3">/</span>
                    <span class="text-blue-500 uppercase">{{ $type }}</span>
                @endif
            </nav>
        </div>
    </div>
    ...
    @if($type === 'main')
        ...
        <section class="py-24 bg-white overflow-hidden">
            <div class="container mx-auto px-6">
                <div class="flex flex-col lg:flex-row items-center gap-16">
                    <div class="lg:w-1/2">
                        <h2 class="text-4xl md:text-5xl font-black text-slate-900 mb-8 font-display">Take a Job Opportunity of a <span class="text-blue-600">Lifetime.</span></h2>
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            <a href="{{ route('careers.apply', ['type' => 'apply']) }}" class="inline-flex items-center justify-center px-10 py-5 bg-blue-600 text-white font-black text-lg rounded-2xl hover:bg-blue-700 transition shadow-2xl shadow-blue-600/20">
                                Submit Your CV
                            </a>
        ...
        <section class="py-24 bg-slate-50 border-y border-slate-100">
            <div class="container mx-auto px-6">
                <div class="text-center max-w-3xl mx-auto mb-20">
                    <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-6">The Best In <span class="text-blue-600">Career Development</span></h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach([
                        ...
                        <div class="p-10 bg-white rounded-[3rem] border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                            <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:text-white transition-colors">
        ...
        <section class="py-24 bg-slate-900 overflow-hidden relative">
            <div class="container mx-auto px-6 text-center">
                <h3 class="text-3xl md:text-5xl font-black text-white mb-8">Ready to <span class="text-blue-500">Scale New Heights?</span></h3>
                ...
                <a href="{{ route('careers.apply', ['type' => 'apply']) }}" class="inline-flex items-center px-12 py-6 bg-blue-600 text-white font-black text-xl rounded-2xl hover:bg-blue-700 transition shadow-2xl shadow-blue-600/40">
                    Apply Now
                </a>
            </div>
        </section>
                    ...
                    <div class="bg-slate-50 rounded-[3rem] border border-slate-100 overflow-hidden">
                        <div class="p-12 md:p-16">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12 pb-12 border-b border-slate-200">
                                <div>
                                    <h2 class="text-3xl font-black text-slate-900 mb-2 font-display">Resume <span class="text-blue-600">Portal</span></h2>
                            ...
                            <form wire:submit.prevent="submit" class="space-y-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" wire:model="fullName" placeholder="Enter your full name" class="w-full px-8 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none font-bold text-slate-700">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="email" wire:model="email" placeholder="email@example.com" class="w-full px-8 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none font-bold text-slate-700">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" wire:model="phone" placeholder="+234 ..." class="w-full px-8 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none font-bold text-slate-700">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-sm font-black text-slate-400 uppercase tracking-widest ml-4">Position Applied For</label>
                                        <select wire:model="position" class="w-full px-8 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none font-bold text-slate-700 appearance-none">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        <div class="absolute inset-0 bg-blue-600 rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity pointer-events-none"></div>
                                        <input type="file" wire:model="resume" class="absolute inset-0 opacity-0 cursor-pointer z-10">
                                        <div class="w-full px-8 py-10 bg-white border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center text-slate-400 transition-all group-hover:border-blue-400">
                                            @if($resume)
                                                <svg class="w-12 h-12 text-blue-600 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                                <span class="text-blue-600 font-bold">{{ $resume->getClientOriginalName() }}</span>
                                            @else
                                    ...
                                    <div wire:loading wire:target="resume" class="text-blue-600 text-xs font-bold ml-4 italic px-2 py-1 bg-blue-50 rounded">Uploading...</div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea wire:model="message" rows="4" placeholder="Tell us about yourself..." class="w-full px-8 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none font-bold text-slate-700"></textarea>
                                </div>
