        ...
        <div class="col-md-6 col-xl-7">
          <ul class="list-xxl pl-5">
            <li>
              <h5>Overview</h5>
              <p>
                Special current account that allow customers to withdraw with our
                cheque in any branch of our correspondence commercial bank (Fidelity Bank) all over Nigeria
              </p>
            </li>
            <li>
              <h5>Main Features</h5>
              <ul class="list-marked">
                <li>Minimum opening balance of N10, 000</li>
                <li>For individuals and companies</li>
                <li>Opportunity to apply for loans and overdraft</li>
              </ul>
            </li>
            <li>
              <h5>Benefits</h5>
            ...
            <li>
              ...
              <ul class="list-marked">
                ...
                <li>Two independent and satisfactory references</li>
