      ...
      <div class="row row-40">
        <div class="col-sm-6 col-lg-6">
          <ul class="list-xl wow fadeIn">
            ...
            <li>
              <h5>How do I get AMJU Unique MFB POS as a merchant?</h5>
              <p class="text-gray-600">
                Open a current account, download our indemnity form and submit it at the nearest AMJU Unique MFB branch.
                Kindly come along with a POS request application letter printed out on your letter-headed paper.
              </p>
            </li>
            <li>
              <h5>Can I access loan as AMJU Unique MFB customer?</h5>
              <p
                class="text-gray-600"
              >AMJU Unique MFB gives loan to expand all our customers businesses as many as are interested.</p>
            </li>
            <li>
              <h5>How can I register AMJU Unique MFB Internet banking?</h5>
              <p class="text-gray-600">
        ...
        <div class="col-sm-6 col-lg-6">
          <ul class="list-xl wow fadeIn">
            <li>
              <h5>Can I use AMJU Unique MFB ATM card to withdraw in every other bank machine?</h5>
              <p
                class="text-gray-600"
              >The Amju Unique Micro Finance Bank ATM card is useable on all ATMs within Nigeria.</p>
            </li>
            <li>
              <h5>Can I transfer money from directly to my AMJU Unique MFB personal account?</h5>
            ...
            <li>
              ...
              <p
                class="text-gray-600"
              >You can transfer up to a maximum of ₦500,000 at once using your AMJU Unique MFB Mobile Banking app</p>
            </li>
            <li>
              <h5>How can I have AMJU Unique MFB Mobile app on my phone?</h5>
              <p class="text-gray-600">
                Amju Unique MFB mobile only can be activated on Android phones at the moment. Visit google play store on your device.
                Search for Amju, click on Amju Unique MFB logo and download. Install the app after downloading and register a new device.
            ...
            <li>
              <h5>How can I open an AMJU Unique MFB bank account?</h5>
              <p class="text-gray-600">
                You can very easily open an account and get your account number in 5 minutes. Simply click
                <router-link :to="{name:'site.account.create'}" class="faq-link">here</router-link>to be AMJU Unique MFB customer.
              </p>
            </li>
          </ul>
        </div>
...
<script>
  import { siteFAQ } from "@assets/js/config";
  export default {
    name: "FAQSection",
    data: () => ({
      faq: {}
    ...
    created() {
      axios.get(siteFAQ).then(({ data: { faq } }) => {
        this.faq = faq;
        this.$emit("faq-loaded");
      });
    }
  };
</script>
