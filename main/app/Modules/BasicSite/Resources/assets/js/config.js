...
export const siteAboutMgtTeam = rootUrl( 'about-us/management-team' )
export const siteAboutCEO = rootUrl( 'about-us/management-team/ceo' )
export const siteAboutAuditor = rootUrl( 'about-us/management-team/internal-audit' )
export const siteAboutED = rootUrl( 'about-us/management-team/executive-director' )
export const siteAboutDGM = rootUrl( 'about-us/management-team/deputy-general-manager' )
export const siteAboutISMS = rootUrl( 'about-us/amju-unique-mfbng-isms-policy' )
